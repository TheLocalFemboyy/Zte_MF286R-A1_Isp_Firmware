...
Hardware version: MF286R-1.0 (the one is without the battery)<br>
...
<br>
## Disassembly
There are small differences between MF286R routers (each isp customized their one's) Some have battery's, some have different pcb's...<br>
<br>
